	...
	*/
	...
	public function insert()
	{
        ...
        if ($model->create()) 
		{
			...
			$shop	=	M('Shop')->where(array('member_id'=>intval(I('post.member_id'))))->find();
			$model->__set('province_id',$shop['province_id']);			$model->__set('city_id',$shop['city_id']);
