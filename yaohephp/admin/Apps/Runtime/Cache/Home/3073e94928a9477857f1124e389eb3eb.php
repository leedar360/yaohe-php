...
function setlatlng(longitude,latitude){
	...
	art.dialog.open('/index.php/Home/Activity/ditu',{lock:false,title:'设置经纬度',width:600,height:400,yesText:'关闭',background: '#000',opacity: 0.87});
}
$(document).ready(function(){
	...
	$('#province_id').change(function(){
		$.ajax({
                type: "post",
                url: "/index.php/Home/Activity/getcitylist",
	...
	$('#city_id').change(function(){
		$.ajax({
                type: "post",
                url: "/index.php/Home/Activity/getarealist",
	...
	$('#area_id').change(function(){
		$.ajax({
                type: "post",
                url: "/index.php/Home/Activity/getdistrictlist",
...
function search()
{
	var url='/index.php/Home/Activity/search_list?province_id='+$('#province_id').val()+'&city_id='+$('#city_id').val();
    	...
    	<div class="viewport" id="console">
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    <ul class="page-tabs"><li class="selected"><a href="/index.php/Home/Activity/copyadd?id=<?php echo ($vo["id"]); ?>" data-permalink="">新增新品</a></li></ul>
                    	<form name="form1" method="post" action="/index.php/Home/Activity/insert" onSubmit="return insert()" enctype="multipart/form-data">
