...
$(document).ready(function(){
	...
	//$('#ajax_list').load('/index.php/Home/IndustryClass/ajax_list?pageNum=<?php echo ($currentPage); ?>');
	$('#province_id').change(function(){
		$.ajax({
                type: "post",
                url: "/index.php/Home/IndustryClass/getcitylist",
	...
	$('#city_id').change(function(){
		$('#ajax_list').load('/index.php/Home/IndustryClass/ajax_list?city_id='+$(this).val()+'&pageNum=<?php echo ($currentPage); ?>');
	});
});
...
function save()
{
	...
	{
		$.ajax({
			url: "/index.php/Home/IndustryClass/save",
			type: "post",
			data: {city_id:$('#city_id').val(),ids:arrs},
			success: function (result) {
				//handle
				alert(result.msg);
				$('#ajax_list').load('/index.php/Home/IndustryClass/ajax_list?city_id='+$('#city_id').val());
			}
		});
	}
}
                    ...
                    <div class="zone-items"><h5>吆喝</h5>
                    	<ul class="level-1">
                            ...
                            <li class="cate has-items computing_networks"><a href="#"><span class="fa fa-computing_networks"></span><span class="text">首页管理</span></a>
                            	<ul class="level-2">
                                	<li class="item instances"><a href="javascript:void(0)" data-permalink=""><span class="fa fa-dot"></span><span class="text">首页分类管理</span></a></li>
                            ...
                            <li class="cate has-items storage"><a href="#"><span class="fa fa-storage"></span><span class="text">商家管理</span></a>
                            	<ul class="level-2">
                                    <li class="item snapshots"><a href="https://console.qingcloud.com/pek1/snapshots/" data-permalink=""><span class="fa fa-dot"></span><span class="text">新增商家</span></a></li>
                                    <li class="item snapshots"><a href="https://console.qingcloud.com/pek1/snapshots/" data-permalink=""><span class="fa fa-dot"></span><span class="text">商家列表</span></a></li>
                            ...
                            <li class="cate has-items security"><a href="#"><span class="fa fa-security"></span><span class="text">权限管理</span></a>
                            	<ul class="level-2">
                                	<li class="item security_groups"><a href="https://console.qingcloud.com/pek1/security_groups/" data-permalink=""><span class="fa fa-dot"></span><span class="text">权限列表</span></a></li>
                                    <li class="item keypairs"><a href="https://console.qingcloud.com/pek1/keypairs/" data-permalink=""><span class="fa fa-dot"></span><span class="text">新增角色</span></a></li>
                                </ul>
                            </li>
                            ...
                            <li class="cate has-items database"><a href="#"><span class="fa fa-database"></span><span class="text">优惠管理</span></a>
                            	<ul class="level-2">
                                	<li class="item rdbs"><a href="https://console.qingcloud.com/pek1/rdbs/" data-permalink=""><span class="fa fa-dot"></span><span class="text">优惠券</span></a></li>
                                    <li class="item caches"><a href="https://console.qingcloud.com/pek1/caches/" data-permalink=""><span class="fa fa-dot"></span><span class="text">会员卡</span></a></li>
                                    <li class="item caches"><a href="https://console.qingcloud.com/pek1/caches/" data-permalink=""><span class="fa fa-dot"></span><span class="text">新品</span></a></li>
                                    <li class="item caches"><a href="https://console.qingcloud.com/pek1/caches/" data-permalink=""><span class="fa fa-dot"></span><span class="text">活动</span></a></li>
                            ...
                            <li class="cate has-items management"><a href="#"><span class="fa fa-management"></span><span class="text">系统设置</span></a>
                            	<ul class="level-2">
                                    ...
                                    <li class="item activities"><a href="/IndustryClass" data-permalink=""><span class="fa fa-dot"></span><span class="text">绑定分类</span></a></li>
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    	...
                    	<div class="toolbar"><a class="btn" href="javascript:void(0)"><span class="icon icon-refresh"></span></a>省份：<div class="select-con"><select class="dropdown-select" name="province_id" id="province_id"><option value="0">请选择</option><?php if(is_array($province_list)): $i = 0; $__LIST__ = $province_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?></select></div>城市：<div class="select-con"><select class="dropdown-select" name="city_id" id="city_id"><option value="0">请选择</option></select></div><input id="all" type="checkbox" value="checkbox">选择全部
                            <!--
