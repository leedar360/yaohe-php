 ...
 ?>
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    <ul class="page-tabs"><li class="selected"><a href="?c=Activity&a=add" data-permalink="">添加活动</a></li></ul>
                    	<form name="form1" method="post" action="?c=Activity&a=insert" onSubmit="return insert()" enctype="multipart/form-data">
                    	<table width="100%" class="table table-bordered table-hover">
							<thead>
								...
								<tr>
								  <th width="127">地址</th>
								  <th align="left"><input type="text" name="address" id="address" value=""/></th>
								</tr>

								<tr>
								  <th width="127">地图：</th>
								  <th align="left"><input type="button"  name="button" value="获取地图" onclick="setlatlng($('#long').val(),$('#lat').val())"/><input type="text1" style="width:150px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" name="long" id="long" value=""/>-<input type="text1" style="width:150px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" name="lat" id="lat" value=""/>
