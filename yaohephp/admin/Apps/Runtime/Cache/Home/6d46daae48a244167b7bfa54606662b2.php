...
$(document).ready(function(){
	...
	//$('#ajax_list').load('?c=NewProduct&a=ajax_list?pageNum=<?php echo ($currentPage); ?>');
	$("#all").click(function(){ 
...
function search()
{
	var url	=	'?c=NewProduct&a=index&province_id='+$('#province_id').val()+'&city_id='+$('#city_id').val();
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    	...
                    	<div class="toolbar"><a class="btn" href="javascript:void(0)"><span class="icon icon-refresh"></span></a><a class="btn" href="?c=NewProduct&a=add"><span class="icon icon-run"></span><span class="text">新建</span></a><a class="btn" href="javascript:void(0)" onclick="del()"><span class="text">删除</span></a>
                            <!--
						...
						<div class="select-con">
							...
							<div class="form-search"><input type="search" id="keywords" placeholder="新品ID/新品名称" value="<?php echo ($keywords); ?>"></div>
						...
						<tbody>
						<?php
 $statusarr[0]='待发布'; $statusarr[1]='上线'; $statusarr[2]='下线'; $statusarr[3]='已结束'; ?>
						...
						<td><img src='http://static.htcheng.com/imgs/<?php echo ($vo["img1"]); ?>' width=100 height=100/></td>
						<td><?php echo ($vo["price"]); ?></td>
						<td><?php echo ($statusarr[$vo['status']]); ?></td>
						<td><?php echo date('Y-m-d H:i',$vo['addtime']);?></td>
						<td><a href='?c=NewProduct&a=edit&id=<?php echo ($vo["id"]); ?>'>修改</a> 
						<?php
 if($vo['status']==0 || $vo['status']==2) { ?>
						<a href='?c=NewProduct&a=online&id=<?php echo ($vo["id"]); ?>'>上线</a> 
						<?php
 } if($vo['status']==1) { ?>
						<a href='?c=NewProduct&a=offline&id=<?php echo ($vo["id"]); ?>'>下线</a>
						<?php
 } ?> 
						<a href='?c=NewProduct&a=copyadd&id=<?php echo ($vo["id"]); ?>'>复制创建</a></td>
