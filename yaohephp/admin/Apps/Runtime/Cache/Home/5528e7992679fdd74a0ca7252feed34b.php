...
<div id="mask" class="mask"></div>
            	...
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    	...
                    	<div class="toolbar">
							...
							<div class="form-search"><input type="search" id="title" placeholder="信息源" value="<?php echo ($title); ?>"></div>
 ...
 $htypearr[0]='评论'; $htypearr[1]='回复'; ?>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="dbclick">
									...
									<td><?php echo ($htypearr[$vo['type']]); ?></td>
									<td><?php echo ($vo['title']); ?></td>
									<td><a href='?c=ShopComment&a=delete&id=<?php echo ($vo["id"]); ?>' onclick="return del()">删除</a></td>
