...
$(document).ready(function(){
	...
	$('#province_id').change(function(){
		$.ajax({
                type: "post",
                url: "/index.php/Home/Card/getcitylist",
	...
	$('#city_id').change(function(){
		$.ajax({
                type: "post",
                url: "/index.php/Home/Card/getarealist",
	...
	$('#area_id').change(function(){
		$.ajax({
                type: "post",
                url: "/index.php/Home/Card/getdistrictlist",
...
function search()
{
	var url='/index.php/Home/Card/search_list?province_id='+$('#province_id').val()+'&city_id='+$('#city_id').val();
...
<div id="mask" class="mask"></div>
            ...
            <div class="nav-zone" style="">
            	<div class="nav-zone-inner">
                    ...
                    <div class="zone-items"><h5>吆喝</h5>
                    	<ul class="level-1">
                        	<?php
 if(in_array('homepage',$classname_arr)) { ?>
 ...
 if(in_array('Rotate',$module_arr)) { ?>
                            ...
                            <li class="cate has-items security"><a href="#"><span class="fa fa-security"></span><span class="text">权限管理</span></a>
                            	<ul class="level-2">
                                	<li class="item security_groups"><a href="/Role" data-permalink=""><span class="fa fa-dot"></span><span class="text">权限列表</span></a></li>
                            ...
                            <li class="cate has-items management"><a href="#"><span class="fa fa-access_keys"></span><span class="text">账号管理</span></a>
                            	<ul class="level-2">
                                	<li class="item security_groups"><a href="/User" data-permalink=""><span class="fa fa-dot"></span><span class="text">用户管理</span></a></li>
                                    <li class="item keypairs"><a href="/ShopUser" data-permalink=""><span class="fa fa-dot"></span><span class="text">商家管理</span></a></li>
                                    <li class="item keypairs"><a href="/AdminUser" data-permalink=""><span class="fa fa-dot"></span><span class="text">管理员管理</span></a></li>
                                </ul>
                            </li>
                            <li class="cate has-items database"><a href="#"><span class="fa fa-database"></span><span class="text">优惠管理</span></a>
                            	<ul class="level-2">
                                    ...
                                    <li class="item caches"><a href="/Call" data-permalink=""><span class="fa fa-dot"></span><span class="text">吆喝</span></a></li>
                                </ul>
                            </li>
                            <li class="cate has-items management"><a href="#"><span class="fa fa-management"></span><span class="text">系统设置</span></a>
                            	<ul class="level-2">
                                	...
                                	<li class="item alarms"><a href="/City" data-permalink=""><span class="fa fa-dot"></span><span class="text">城市管理</span></a></li>
									<li class="item alarms"></li>
                            ...
                            <li class="cate has-items management"><a href="#"><span class="fa fa-subusers"></span><span class="text">评论管理</span></a>
                            	<ul class="level-2">
                                	<li class="item alarms"><a href="/DynamicComment" data-permalink=""><span class="fa fa-dot"></span><span class="text">动态评论</span></a></li>
                                    <li class="item schedulers"><a href="/ShopComment" data-permalink=""><span class="fa fa-dot"></span><span class="text">店铺点评</span></a></li>
                                </ul>
                            </li>
							
                            <li class="cate has-items management"><a href="#"><span class="fa fa-notification_lists"></span><span class="text">其它管理</span></a>
                            	<ul class="level-2">
                                	<li class="item alarms"><a href="/Opinion" data-permalink=""><span class="fa fa-dot"></span><span class="text">意见反馈</span></a></li>
                                    <li class="item schedulers"><a href="/Report" data-permalink=""><span class="fa fa-dot"></span><span class="text">举报管理</span></a></li>
                                </ul>
                            </li>
            	...
            	<div>
                    ...
                    <div class="items-inner">
                        ...
                        <ul class="global-items">
                            ...
                            <li class="nav-item"><a class="nav-item-inner" href="/Login/logout"><span class="fa fa-activities"></span></a>
                            	<div class="dropdown-menu" style="display: none;">
                                </div>
                            </li>
                        </ul>
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    <ul class="page-tabs"><li class="selected"><a href="/index.php/Home/Card/copyadd?id=<?php echo ($vo["id"]); ?>" data-permalink="">编辑优惠券</a></li></ul>
                    	<form name="form1" method="post" action="/index.php/Home/Card/update" onSubmit="return insert()" enctype="multipart/form-data">
                    	...
                    	<table width="100%" class="table table-bordered table-hover">
							<thead>
								...
								<tr>
								  <th width="127">折扣：</th>
								  <th align="left"><input type="text"  name="discount" id="discount" value="<?php echo ($vo["discount"]); ?>"/>折</th>
								  </tr>
