 ...
 ?>
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    <ul class="page-tabs"><li class="selected"><a href="?c=Card&a=edit?id=<?php echo ($vo["id"]); ?>" data-permalink="">编辑优惠券</a></li></ul>
                    	<form name="form1" method="post" action="?c=Card&a=update" onSubmit="return update()" enctype="multipart/form-data">
