...
function search()
{
	var url='?c=Card&a=search_list&province_id='+$('#province_id').val()+'&city_id='+$('#city_id').val();
 ...
 ?>
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    <ul class="page-tabs"><li class="selected"><a href="?c=Card&a=add" data-permalink="">添加会员卡</a></li></ul>
                    	<form name="form1" method="post" action="?c=Card&a=insert" onSubmit="return insert()" enctype="multipart/form-data">
                    	<table width="100%" class="table table-bordered table-hover">
							<thead>
								...
								<tr>
								  <th width="127">折扣：</th>
								  <th align="left"><input type="text"  name="discount" id="discount"/>折</th>
								  </tr>
								<tr>
								...
								<tr>
								  ...
								  <th align="left"><input type="text1" name="online_time" id="online_time" style="width:150px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" name="valid_start" id="valid_start" class="Wdate" onfocus="WdatePicker()" value="<?php echo date('Y-m-d');?>"/></th>
								</tr>
								<tr>
								  <th width="127">&nbsp;</th>
