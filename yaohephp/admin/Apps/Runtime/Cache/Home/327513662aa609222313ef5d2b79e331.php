            	...
            	<div class="wrapper page">
                    ...
                    <div class="pane">
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
							<?php
 $statusarr[0]='未处理'; $statusarr[1]='已处理'; $reason[0]='色情'; $reason[1]='谣言'; $reason[2]='政治'; $reason[3]='网站钓鱼'; $reason[4]='诱导分享'; $zdxh[0]='Android'; $zdxh[1]='Iphone'; ?>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="dbclick">
									...
									<td><?php echo ($reason[$vo['reason']]); ?></td>
									<td><?php echo ($vo["content"]); ?></td>
									<td><?php echo ($vo["shop_name"]); ?></td>
									<td><?php echo $vo['addtime'];?></td>
									<td><?php echo ($zdxh[$vo['terminal']]); ?></td>
									<td><?php echo ($statusarr[$vo['status']]); ?></td>
									<td><a href='?c=Report&a=delete&id=<?php echo ($vo["id"]); ?>' onclick="return del()">删除</a></td>
