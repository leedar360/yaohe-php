...
$(document).ready(function(){
	...
	$('#ajax_list').load('?c=BindingClass&a=ajax_list&city_id=<?php echo ($city_id); ?>&pageNum=<?php echo ($currentPage); ?>');
	...
	$('#city_id').change(function(){
		$('#ajax_list').load('?c=BindingClass&a=ajax_list&city_id='+$(this).val()+'&pageNum=<?php echo ($currentPage); ?>');
	});
	<?php
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    	...
                    	<div class="toolbar"><a class="btn" href="javascript:void(0)"><span class="icon icon-refresh"></span></a>省份：<div class="select-con"><select class="dropdown-select" name="province_id" id="province_id"><option value="0">请选择</option><?php if(is_array($province_list)): $i = 0; $__LIST__ = $province_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?></select></div>城市：<div class="select-con"><select class="dropdown-select" name="city_id" id="city_id"><option value="0">请选择</option>
