...
function search()
{
	var url	=	'?c=Amusing&a=index&start_date='+$('#start_date').val()+'&end_date='+$('#end_date').val();
...
<div id="mask" class="mask"></div>
            	...
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    	...
                    	<div class="toolbar">
							...
							<div class="form-search">活动时间：
							<input type="text1" style="width:150px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" name="start_date" id="start_date" class="Wdate" onfocus="WdatePicker()" value="<?php echo ($start_date); ?>"/>至<input type="text1" style="width:150px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" name="start_date" id="end_date" class="Wdate" onfocus="WdatePicker()" value="<?php echo ($end_date); ?>"/></div>
							...
							<div class="form-search"><input type="search" id="keywords" placeholder="活动名称/活动序号" value="<?php echo ($keywords); ?>"></div>
 ...
 $statusarr[0]='上线'; $statusarr[1]='下线'; ?>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="dbclick">
									...
									<td><a href='?c=Amusing&a=view&id=<?php echo ($vo["id"]); ?>'><?php echo ($vo["title"]); ?></a></td>
									<td><?php echo ($vo["prize_num"]); ?></td>
									<td><?php echo ($vo["num"]); ?></td>
									<td><?php echo ($vo["start_date"]); ?>至<?php echo ($vo["end_date"]); ?></td>
									<td><?php echo ($statusarr[$vo['status']]); ?></td>
									<td><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
									<td><!--审核通过 上线--> <a href='?c=Amusing&a=edit&id=<?php echo ($vo["id"]); ?>'>编辑</a> <a href='?c=Amusing&a=delete&id=<?php echo ($vo["id"]); ?>' onclick="return del()">删除</a></td>
