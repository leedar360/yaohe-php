...
$(document).ready(function(){
	...
	//$('#ajax_list').load('?c=Card&a=ajax_list?pageNum=<?php echo ($currentPage); ?>');
	$("#all").click(function(){ 
...
<div id="mask" class="mask"></div>
            	...
            	<div class="wrapper page">
                    ...
                    <div class="pane">
						...
						<div class="select-con">
							...
							<div class="form-search"><input type="search" id="keywords" placeholder="会员卡ID/会员卡名称" value="<?php echo ($keywords); ?>"></div>
 ...
 $typearr[0]='满减券'; $typearr[1]='满赠券'; $typearr[2]='代金券'; $typearr[3]='折扣券'; $statusarr[0]='待发布'; $statusarr[1]='上线'; $statusarr[2]='下线'; $statusarr[3]='已结束'; ?>
						...
						<td><a href='?c=Card&a=edit&id=<?php echo ($vo["id"]); ?>'>修改</a>
						<?php
 if($vo['status']==0 || $vo['status']==2) { ?>
						<a href='?c=Card&a=online&id=<?php echo ($vo["id"]); ?>'>上线</a> 
						<?php
 } if($vo['status']==1) { ?>
						<a href='?c=Card&a=offline&id=<?php echo ($vo["id"]); ?>'>下线</a>
						<?php
 } ?>
						<a href='?c=Card&a=copyadd&id=<?php echo ($vo["id"]); ?>'>复制创建</a></td>
