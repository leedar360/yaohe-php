            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
						...
						<div class="form-search"><input type="search" id="name" placeholder="姓名" value="<?php echo ($name); ?>"></div>
						...
						<div id="ajax_list">
							<table class="table table-bordered table-hover">
								...
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr d_id="<?php echo ($vo["id"]); ?>" class="dbclick">
										...
										<td>
										<a href='?c=AdminUser&a=edit&id=<?php echo ($vo["id"]); ?>'>编辑</a> 
										<!--<a href='?c=AdminUser&a='>禁止</a> -->
										<a href='?c=AdminUser&a=delete&id=<?php echo ($vo["id"]); ?>' onclick="return del('<?php echo ($vo["login"]); ?>')">删除</a>
										</td>
