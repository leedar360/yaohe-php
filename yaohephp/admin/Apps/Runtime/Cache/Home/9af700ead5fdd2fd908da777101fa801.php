            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    	...
                    	<div class="toolbar">
							<div class="form-search"><input type="search" id="title" placeholder="商家名称/商家编号" value="<?php echo ($title); ?>"></div>
						...
						<table class="table table-bordered table-hover">
							...
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="dbclick">
									...
									<td><a href='?c=Shop&a=view&id=<?php echo ($vo["id"]); ?>'><?php echo ($vo["s_title"]); ?></a></td>
									<td><?php echo ($vo["content"]); ?></td>
									<td>
									<?php
 if(!empty($vo['img6'])) { $img=$vo['img6']; } if(!empty($vo['img5'])) { $img=$vo['img5']; } if(!empty($vo['img4'])) { $img=$vo['img4']; } if(!empty($vo['img3'])) { $img=$vo['img3']; } if(!empty($vo['img2'])) { $img=$vo['img2']; } if(!empty($vo['img1'])) { $img=$vo['img1']; } if(isset($img)) { ?>
									<img src='http://static.htcheng.com/imgs/<?php echo $img;?>' width="100" height="100" />
									<?php
 } ?>
									</td>
									<td><?php echo ($vo["title"]); ?></td>
									<td><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
									<td><!--审核通过 上线--> <a href='?c=Call&a=view&id=<?php echo ($vo["id"]); ?>'>查看</a></td>
