            	...
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    	...
                    	<div class="toolbar"><a class="btn" href="?c=Rotate&a=add"><span class="icon icon-run"></span><span class="text">新建</span></a>
							...
							<div class="form-search"><input type="search" id="keywords" placeholder="关键字" value="<?php echo ($keywords); ?>"></div>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
							<?php
 $statusarr[0]='待发布'; $statusarr[1]='上线'; $statusarr[2]='下线'; $typearr[0]='商家'; $typearr[1]='优惠券'; $typearr[2]='会员卡'; $typearr[3]='活动'; $typearr[4]='新品'; $typearr[5]='网址'; ?>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="dbclick">
									<td><input type="text" name="order_num[]" id="order_num[]" style="width:50px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" value="<?php echo ($vo["order_num"]); ?>">
									<input type="hidden" name="id[]" value="<?php echo ($vo["id"]); ?>" />
									</td>
									<td><?php echo ($vo["title"]); ?></td>
									<td><img src='http://static.htcheng.com/imgs/<?php echo ($vo["img"]); ?>' width=100 height=100></td>
									<td><?php echo ($typearr[$vo['type']]); ?></td>
									<td><?php echo ($vo["city_id"]); ?></td>
									<td><?php echo ($vo["one_id"]); ?></td>
									<td><?php echo ($statusarr[$vo['status']]); ?></td>
									<td><?php echo ($vo["up_admin_username"]); ?><br /><?php echo date("Y-m-d H:i:s",$vo['last_update_time']);?></td>
									<td>
										<?php
 if($vo['status']==0 || $vo['status']==2) { ?>
										<a href='?c=Rotate&a=online&id=<?php echo ($vo["id"]); ?>'>上线</a> 
										<a href='?c=Rotate&a=edit&id=<?php echo ($vo["id"]); ?>'>编辑</a> 
										<?php
 } if($vo['status']==1) { ?>
										<a href='?c=Rotate&a=offline&id=<?php echo ($vo["id"]); ?>'>下线</a>
										<?php
 } ?>
									</td>
