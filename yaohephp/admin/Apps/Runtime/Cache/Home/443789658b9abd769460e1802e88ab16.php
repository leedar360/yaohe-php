...
$(document).ready(function(){
	...
	<?php
 if($type!='' && $type<4) { echo "$('#type').val(".$type.");\n"; } if($h_type!='' && $h_type<4) { echo "$('#h_type').val(".$h_type.");\n"; } ?>
});
function search()
{
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    	...
                    	<div class="toolbar">
							<div class="form-search"><input type="search" id="mid" placeholder="ID/店名" value="<?php echo ($mid); ?>"></div>
							<div class="form-search"><input type="search" id="source_title" placeholder="信息源" value="<?php echo ($source_title); ?>"></div>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
							<?php
 $typearr[0]='优惠券'; $typearr[1]='会员卡'; $typearr[2]='活动'; $typearr[3]='新品'; $typearr[4]='纯吆喝'; $htypearr[0]='评论'; $htypearr[1]='回复'; ?>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="dbclick">
									...
									<td><?php echo ($htypearr[$vo['h_type']]); ?></td>
									<td><?php echo ($vo['title']); ?></td>
									<td><a href='?c=DynamicComment&a=delete&id=<?php echo ($vo["id"]); ?>' onclick="return del()">删除</a></td>
