...
<div id="mask" class="mask"></div>
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <ul class="page-tabs"><li class="selected"><a href="?c=Amusing&a=add" data-permalink="">新增好玩活动</a></li></ul>
                    	<form name="form1" method="post" action="/index.php?c=Amusing&a=update" onSubmit="return insert()">
						<input type="hidden" name="id" value="<?php echo ($row["id"]); ?>" />
                    	<table width="100%" class="table table-bordered table-hover">
							<thead>
								<tr>
									<th width="127"><span style="color:#FF0000;">*</span>活动名称</th>
									<th width="972" align="left"><input name="title" type="text" id="title" size="40" value="<?php echo ($row["title"]); ?>"/></th>
								</tr>
								<tr>
									<th width="127"><span style="color:#FF0000;">*</span>活动类型</th>
									<th width="972" align="left"><input name="type" type="text" id="type" size="40" value="<?php echo ($row["type"]); ?>" /></th>
								</tr>
								<tr>
								  <th width="127"><span style="color:#FF0000;">*</span>活动描述</th>
								  <th align="left"><textarea name="describe" id="describe" cols="25" rows="10"><?php echo ($row["describe"]); ?></textarea></th>
								  </tr>
								<tr>
								  <th width="127"><span style="color:#FF0000;">*</span>活动规则</th>
								  <th align="left"><textarea name="rule" id="rule" cols="25" rows="10"><?php echo ($row["rule"]); ?></textarea></th>
								  </tr>
								<tr>
								  <th width="127">活动时间</th>
								  <th align="left"><input type="text1" style="width:150px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" name="start_date" id="start_date" class="Wdate" onfocus="WdatePicker()" value="<?php echo ($row["start_date"]); ?>"/>至<input type="text1" style="width:150px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" name="end_date" id="end_date" class="Wdate" onfocus="WdatePicker()" value="<?php echo ($row["end_date"]); ?>"/></th>
								</tr>
								<tr>
 ...
 foreach($list as $key=>$item) { ?>
								<tr>
								  <th width="127">奖品<?php echo ($key+1); ?>：</th>
								  <th align="left">
									<input type="hidden" name="prize_id[]" value="<?php echo ($item["id"]); ?>" />
									<input name="prize_title[]" type="text" id="prize_title[]" size="10" style="width:100px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" placeholder="奖品名称" value="<?php echo ($item["title"]); ?>"/>
									
									  <input name="prize_num[]" type="text" id="prize_num[]" size="10" style="width:100px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" placeholder="中奖数量" value="<?php echo ($item["num"]); ?>"/>
									  
									  <input name="prize_rate[]" type="text" id="prize_rate[]" size="10" style="width:100px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" placeholder="中奖千分比" value="<?php echo ($item["rate"]); ?>"/>‰</th>
								  </tr>
								<?php
 } ?>
								<tr>
