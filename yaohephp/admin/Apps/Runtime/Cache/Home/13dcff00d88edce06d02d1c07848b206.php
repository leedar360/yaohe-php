...
$(document).ready(function(){
	...
	$('#role_id').val(<?php echo ($vo["role_id"]); ?>);
});
function update()
{
	...
	if($.trim($('#login_pass').val())!=$.trim($('#login_pass_1').val()))
	{
		alert('两次密码不一致!');
		$('#login_pass_1').focus();
		return false;
 ...
 ?>
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    <ul class="page-tabs"><li class="selected"><a href="?c=AdminUser&a=edit?id=<?php echo ($vo["id"]); ?>" data-permalink="">编辑管理员</a></li></ul>
                    	<form name="form1" method="post" action="?c=AdminUser&a=update" onSubmit="return update()" enctype="multipart/form-data">
                    	<table width="100%" class="table table-bordered table-hover">
							<thead>

								<tr>
								  <th width="103"><span style="color:#FF0000;">*</span>账号<input type="hidden" name="id" value="<?php echo ($vo["id"]); ?>" /></th>
								  <th colspan="4" align="left"><input name="login_user" type="text" id="login_user" size="40" value="<?php echo ($vo["login_user"]); ?>" /></th>
								  </tr>
								<tr>
								  <th width="103"><span style="color:#FF0000;">*</span>密码</th>
								  <th colspan="4" align="left"><input name="login_pass" type="password" id="login_pass" size="40" />不填写则不修改密码</th>
								  </tr>
								<tr>
								  <th width="103"><span style="color:#FF0000;">*</span>确认密码</th>
								  <th colspan="4" align="left"><input name="login_pass_1" type="password" id="login_pass_1" size="40" /></th>
								  </tr>
								<tr>
								  <th width="103">权限组</th>
									<th colspan="4" align="left">
									<select name="role_id" id="role_id">
									<?php if(is_array($role_list)): $i = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
									</th>
								  </tr>
								<tr>
								  <th width="103"><span style="color:#FF0000;">*</span>姓名</th>
								  <th colspan="4" align="left"><input name="name" type="text" id="name" size="40" value="<?php echo ($vo["name"]); ?>" /></th>
								  </tr>
								<tr>
								  <th width="103">电话</th>
								  <th colspan="4" align="left"><input name="tel" type="text" id="tel" size="40" value="<?php echo ($vo["tel"]); ?>"/></th>
								  </tr>
								<tr>
								  <th width="103">备注</th>
								  <th colspan="4" align="left"><textarea name="remark" id="remark" cols="45" rows="5"><?php echo ($vo["remark"]); ?></textarea></th>
								  </tr>
								<tr>
								  <th width="103">&nbsp;</th>
