...
$(document).ready(function(){
	...
	//$('#ajax_list').load('?c=Activity&a=ajax_list?pageNum=<?php echo ($currentPage); ?>');
	$("#all").click(function(){ 
...
<div id="mask" class="mask"></div>
            	...
            	<div class="wrapper page">
                    ...
                    <div class="pane">
						...
						<div class="select-con">
							...
							<div class="form-search"><input type="search" id="keywords" placeholder="活动ID/活动标题" value="<?php echo ($keywords); ?>"></div>
 ...
 $statusarr[0]='待发布'; $statusarr[1]='上线'; $statusarr[2]='下线'; $statusarr[3]='已结束'; ?>
						...
						<td><?php echo ($vo['start_date']); ?><br /><?php echo ($vo['end_date']); ?></td>
						<td><?php echo date('Y-m-d H:i',$vo['addtime']);?></td>
						<td><a href='?c=Activity&a=edit&id=<?php echo ($vo["id"]); ?>'>修改</a> 
						<?php
 if($vo['status']==0 || $vo['status']==2) { ?>
						<a href='?c=Activity&a=online&id=<?php echo ($vo["id"]); ?>'>上线</a> 
						<?php
 } if($vo['status']==1) { ?>
						<a href='?c=Activity&a=offline&id=<?php echo ($vo["id"]); ?>'>下线</a>
						<?php
 } ?>  <a href='?c=Activity&a=copyadd&id=<?php echo ($vo["id"]); ?>'>复制创建</a></td>
