...
<div id="mask" class="mask"></div>
                    ...
                    <ul class="page-tabs"></ul>
                    	<table width="100%" class="table table-bordered table-hover">
							<thead>
								<tr>
									<th width="127">商家</th>
									<th width="972" align="left"><?php echo ($shop_name); ?></th>
								</tr>
								<tr>
								  <th width="127">内容</th>
								  <th align="left"><?php echo ($vo["content"]); ?></textarea></th>
								  </tr>
								<?php
 if(!empty($vo['img1'])) { ?>
								<tr>
 ...
 if(!empty($vo['img6'])) { ?>
								...
								<tr>
								  <th width="127">引用</th>
								  <th align="left"><?php echo ($vo["title"]); ?></th>
								</tr>

								<tr>
								  <th width="127">发布时间：</th>
								  <th align="left"><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></th>
								  </tr>
								<tr>
								  <th width="127">&nbsp;</th>
								  <th align="left">点赞：<?php echo ($vo["zan_num"]); ?> 收藏：<?php echo ($vo["collection_num"]); ?> 评论：<?php echo ($vo["comment_num"]); ?></th>
								  </tr>
							</thead>
							<tbody>
