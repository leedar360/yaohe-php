                    ...
                    <ul class="page-tabs"><li class="selected"><a href="?c=NewProduct&a=add" data-permalink="">添加新品</a></li></ul>
                    	...
                    	<table width="100%" class="table table-bordered table-hover">
							<thead>
								...
								<tr>
								  <th width="127">日期</th>
								  <th align="left"><input type="text1" style="width:150px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" name="day" id="day" class="Wdate" onfocus="WdatePicker()" value="<?php echo date("Y-m-d");?>"/></th>
								</tr>
								<tr>
								  <th width="127">&nbsp;</th>
