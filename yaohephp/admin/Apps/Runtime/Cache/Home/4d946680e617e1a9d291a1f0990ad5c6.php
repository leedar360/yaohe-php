 ...
 ?>
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    <ul class="page-tabs"><li class="selected"><a href="?c=NewProduct&a=edit?id=<?php echo ($vo["id"]); ?>" data-permalink="">编辑新品</a></li></ul>
                    	<form name="form1" method="post" action="?c=NewProduct&a=update" onSubmit="return update()" enctype="multipart/form-data">
