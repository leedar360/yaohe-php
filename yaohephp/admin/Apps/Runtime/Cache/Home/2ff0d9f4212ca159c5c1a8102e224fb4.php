...
$(document).ready(function(){
	...
	$('#province_id').val(<?php echo ($vo["province_id"]); ?>);
	$('#city_id').val(<?php echo ($vo["city_id"]); ?>);
	$('#area_id').val(<?php echo ($vo["area_id"]); ?>);
	$('#district_id').val(<?php echo ($vo["district_id"]); ?>);
	$('#one_id').val(<?php echo ($vo["one_id"]); ?>);
	$('#industry_class_id').val(<?php echo ($vo["industry_class_id"]); ?>);
});
...
<div id="mask" class="mask"></div>
 ...
 ?>
            ...
            <div class="content" style="">
            	<div class="wrapper page">
                    ...
                    <div class="pane">
                    <ul class="page-tabs"><li class="selected"><a href="?c=Shop&a=edit&id=<?php echo ($vo["id"]); ?>" data-permalink="">基本信息</a></li><li class=""><a href="?c=Shop&a=contract&id=<?php echo ($vo["id"]); ?>" data-permalink="">商家合同</a></li></ul>
                    	...
                    	<table width="100%" class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th width="972" align="left"><?php echo ($vo["mobile"]); ?><input type="hidden" name="id" value="<?php echo ($vo["id"]); ?>" /></th>
								</tr>
								<tr>
									<th width="127"><span style="color:#FF0000;">*</span>店铺名称</th>
									<th width="972" align="left"><input name="title" type="text" id="title" size="40" value="<?php echo ($vo["title"]); ?>"/></th>
								</tr>
								<tr>
								  <th width="127"><span style="color:#FF0000;">*</span>所属城市</th>
								  <th align="left"><select name="province_id" id="province_id">
									<option value="0">请选择</option>
									<?php if(is_array($province_list)): $i = 0; $__LIST__ = $province_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								...
								<tr>
								  ...
								  <th align="left"><select name="one_id" id="one_id">
									...
									<select name="industry_class_id" id="industry_class_id">
									  <option value="0">请选择</option>
									<?php if(is_array($industry_class_list)): $i = 0; $__LIST__ = $industry_class_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select></th>
								  </tr>
								<tr>
								  ...
								  <th align="left">
									...
									<option value="0">请选择</option>
									<?php if(is_array($area_list)): $i = 0; $__LIST__ = $area_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
									<select name="district_id" id="district_id">
									<option value="0">请选择</option>
									<?php if(is_array($district_list)): $i = 0; $__LIST__ = $district_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select></th>
								  </tr>
								<tr>
								  <th width="127"><span style="color:#FF0000;">*</span>营业时间</th>
								  <th align="left"><input name="business_time" type="text" id="business_time" size="40" value="<?php echo ($vo["business_time"]); ?>"/></th>
								  </tr>
								<tr>
								  <th width="127"><span style="color:#FF0000;">*</span>预约电话</th>
								  <th align="left"><input name="subscribe_tel" type="text" id="subscribe_tel" size="40" value="<?php echo ($vo["subscribe_tel"]); ?>"/></th>
								  </tr>
								<tr>
								  <th width="127"><span style="color:#FF0000;">*</span>详细地址</th>
								  <th align="left"><input name="address" type="text" id="address" size="40" value="<?php echo ($vo["address"]); ?>"/></th>
								  </tr>
								<tr>
								  <th width="127">地图标点</th>
								  <th align="left">坐标<span id="long_lat_txt">（<?php echo ($vo["lng"]); ?>，<?php echo ($vo["lat"]); ?>）</span>
									<input type="hidden" name="lng" id="lng" value="<?php echo ($vo["lng"]); ?>" />
									<input type="hidden" name="lat" id="lat" value="<?php echo ($vo["lat"]); ?>" />
 ...
 if(!empty($vo['img'])) { ?>
								<tr>
								  ...
								  <th align="left"><img src='http://static.htcheng.com/imgs/<?php echo ($vo["img"]); ?>' width="200" height="200" ></th>
								</tr>
								<?php
 } ?>
								<tr>
								...
								<tr>
								  ...
								  <th align="left"><input name="per_person" type="text" id="per_person" size="40" value="<?php echo ($vo["per_person"]); ?>"/></th>
								  </tr>
								<tr>
								  <th width="127">搜索关键词</th>
								  <th align="left"><input name="keywords[]" type="text" id="keywords1" size="10" style="width:100px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" value="<?php echo ($keywords_list[0]['title']); ?>"/>
									-
									  <input name="keywords[]" type="text" id="keywords2" size="10" style="width:100px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" value="<?php echo ($keywords_list[1]['title']); ?>"/>
									  -
									  <input name="keywords[]" type="text" id="keywords3" size="10" style="width:100px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" value="<?php echo ($keywords_list[2]['title']); ?>"/>
									  -
									  <input name="keywords[]" type="text" id="keywords4" size="10" style="width:100px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" value="<?php echo ($keywords_list[3]['title']); ?>"/>
									  -
									  <input name="keywords[]" type="text" id="keywords5" size="10" style="width:100px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px" value="<?php echo ($keywords_list[4]['title']); ?>"/></th>
								  </tr>
								<tr>
								  <th width="127">商家介绍</th>
								  <th align="left"><textarea name="content" id="content" cols="45" rows="20"><?php echo ($vo["content"]); ?></textarea></th>
								  </tr>
								<tr>
								  <th width="127">&nbsp;</th>
